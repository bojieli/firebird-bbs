...
/* $Id: averun.c,v 1.2 2000/02/11 01:47:51 skyo Exp $ */
...
int     draw_pic()
{
        ...
        for (i = MAX_LINE; i >= 0; i--)
        {
                ...
                fprintf(fp,"[1;36m¢x[m");
                fprintf(fp, "\n");
        }
        time(&now);
        fprintf(fp, "[1;37m  0 [36m¢|¢w¢w¢w[37m¤j¬õªáªº°ê«×¥­§¡­t¸ü¤H¼Æ²Î­p[36m¢w¢w");
        fprintf(fp, "¢w¢w[37m%s[36m¢w¢w¢w¢}[m\n", Ctime(&now));
