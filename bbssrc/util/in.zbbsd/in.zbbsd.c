...
/* 990609.edwardc what's "SECURE_BBSID" will do ?
   FB ¨t¦Cªº¹w³]¦w¸Ëµ{§Ç, bbs ³o­Ó±b¸¹¬O¤£»Ý³]©w¯µ½Xªº, ¦ý­Y¨Ï¥Î¤F
   in.zbbsd/telnetd ¥H«á, bbs ±b¸¹¤£³]¯¦½Xªº²z¥Ñ¥H¸g®ø¥¢¤F, NULL passwd
   ¤]³\·|±a¨Ó¨Ç¦w¥þ°ÝÃD, ¥´¶}¦¹¿ï¶µ«á, in.zbbsd ±N±µ¨ü¦³³]¯µ½Xªº bbs ±b¸¹ */
...
#define BANNER  "\r\nFirebird BBS 3.0 ¤õ³¾ BBS ¨t²Î [bbs.firebird.dhs.org]\r\n\n"
...
get_tty()
{
  ...
  *busy = 0;
  ...
  fatal(net, maple);
#else
  fatal(net, "©êºp¡A«Èº¡¤F¡A½Ðµy«á¦A¨Ó¡C(visit)");
#endif
}
...
start_client()
{
  ...
  {
    sleep(2);
    fatal(net, "©êºp¡A«Èº¡¤F¡A½Ðµy«á¦A¨Ó(tty)");
  }
