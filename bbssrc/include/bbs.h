...
#define NUMPERMS   (30)
#define REG_EXPIRED         180    /* 暗ō絋粄戳 */
#define MAXGUEST			 16	   /* 程 guest 眀腹计 */

#define FILE_BUFSIZE        200    /* max. length of a file in SHM*/
#define FILE_MAXLINE         25    /* max. line of a file in SHM */
#define MAX_WELCOME          15    /* 舧礶计 */
#define MAX_GOODBYE          15    /* 瞒礶计 */
#define MAX_ISSUE            15    /* 程秈礶计 */
#define MAX_DIGEST         1000    /* 程ゅ篕计 */
...
#ifdef CODE_VALID
  #define RNDPASSLEN		 10	   /* 穞絏粄靡穞絏 (続﹜絛瞅 4~10)*/
#endif
